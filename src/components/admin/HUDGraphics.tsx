...
export const BlinkingIndicator = ({ label = "TX/RX", color = "#000", isWhite = false, interval = 800 }) => {
  ...
  return (
    <div className={`flex items-center gap-1.5 text-[10px] font-bold tracking-widest ${isWhite ? 'text-white' : 'text-black'}`}>
      <div 
